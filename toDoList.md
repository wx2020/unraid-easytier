...
### P2 — 一般
- [x] **S-05/S-06/S-08** 输入输出加固与 `isRunning` 统一
- [x] **R-07/R-09/R-10/R-11** hosts 并发、缓存、文档与禁用语义统一
- [x] **C-03..C-08** 死代码、正则、超时、页面复用清理
- [x] **W-02/W-04/W-05/W-06** 日志自动刷新、Dashboard 结构化、前端校验、下载完整性
- [x] **B-04/B-05** 构建压缩格式统一与 PR 负向断言
- [x] **I-01** 中英文档同步
- [x] **T-03** CA 校验增强
